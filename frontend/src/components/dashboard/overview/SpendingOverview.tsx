  ...
  return (
    <Card className="flex flex-col">
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-2 rounded-lg border border-border bg-finance-warning-bg p-3">
          <TrendingUp
            className="h-5 w-5 shrink-0 text-finance-warning"
            aria-hidden="true"
          />
          <p className="text-xs font-medium text-finance-warning">
