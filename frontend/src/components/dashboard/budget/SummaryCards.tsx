...
export default function SummaryCards({
    totalIncome, incomePct, budgetTargets, getBarColor,
    totalExpenses, expensesPct, totalSavings, savingsPct, netBalance, savingsRate,
}: SummaryProps) {
    return (
        <div className="flex gap-3 overflow-x-auto snap-x snap-mandatory pb-2 md:grid md:grid-cols-2 lg:grid-cols-4 md:overflow-visible md:pb-0">
            <Card className="border min-w-[80%] snap-center shrink-0 md:min-w-0 md:shrink">
                <CardHeader>
                    <CardTitle className="flex items-center gap-1 text-lg">
                        <ArrowUpRight className="text-green-600 dark:text-green-400" /> Income
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="mt-3 space-y-1">
                        ...
                        <div className="h-1.5 w-full rounded-full bg-slate-200 dark:bg-slate-800">
                            <div className={`h-1.5 rounded-full transition-all ${getBarColor(incomePct)}`} style={{ width: `${incomePct}%` }} />
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border min-w-[80%] snap-center shrink-0 md:min-w-0 md:shrink">
                <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg">
                        <ArrowDownRight className="text-red-600 dark:text-red-400" /> Expenses
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="mt-3 space-y-1">
                        ...
                        <div className="h-1.5 w-full rounded-full bg-slate-200 dark:bg-slate-800">
                            <div className="h-1.5 rounded-full transition-all bg-red-500" style={{ width: `${expensesPct}%` }} />
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border min-w-[80%] snap-center shrink-0 md:min-w-0 md:shrink">
                ...
                <CardContent>
                    ...
                    <div className="mt-3 space-y-1">
                        ...
                        <div className="h-1.5 w-full rounded-full bg-slate-200 dark:bg-slate-800">
                            <div className={`h-1.5 rounded-full transition-all ${getBarColor(savingsPct)}`} style={{ width: `${savingsPct}%` }} />
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border min-w-[80%] snap-center shrink-0 md:min-w-0 md:shrink">
                <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg">
                        <DollarSign className="text-violet-600 dark:text-violet-400" /> Net balance
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="mt-3 space-y-1">
                        ...
                        <div className="h-1.5 w-full rounded-full bg-slate-200 dark:bg-slate-800">
                            <div className="h-1.5 rounded-full transition-all bg-violet-500" style={{ width: `${Math.abs(savingsRate)}%` }} />
                        </div>
                    </div>
                </CardContent>
            </Card>
